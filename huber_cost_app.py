...
MODEL_PATH = APP_DIR / "无灭菌纱布AI报价数据_成本预测模型.joblib"
...
def load_model_bundle() -> dict[str, object]:
    ...
    candidates.extend(sorted(APP_DIR.glob("*.joblib"), key=lambda p: p.stat().st_mtime, reverse=True))
